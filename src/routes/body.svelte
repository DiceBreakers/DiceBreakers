...
<!-- Custom Conversation Starter Google Sheet -->
		<div class="card p-4 variant-glass-tertiary">
				<div class="card p-4">
					...
					<a href="https://docs.google.com/spreadsheets/d/1yLYJn7PymbJina8qVlA-_xLPkjHMDemPrggxyLMr-xQ/edit#gid=1167157860">
						<b>Click Here</b></a> to access the Google Sheet template, and tailor it to fit your group!
				</div>
		</div>
