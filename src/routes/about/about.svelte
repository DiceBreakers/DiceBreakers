<div class="body center-text">
	<div class="card p-4 variant-glass-tertiary">
		<div class="card p-4">
            ...
            <br>
            <p>My goal is to provide a platform for positive, thought provoking, or meaningful conversations. In person, online, wherever works to get people to connect and talk a little bit more!
            ...
            I'm by no means an experienced developer, so I'm figuring things out as I go. I think I've done okay, but if you have suggestions, I'm very receptive to community input! I don't know if anyone has even read this, but if you do have any suggestions please email me at <a href="mailto:suggestions@DiceBreakers.app">suggestions@DiceBreakers.app!</a></p>
        </div>
    </div>
</div>